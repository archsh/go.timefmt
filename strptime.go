...
var input_converters = map[rune]func(string, *_DateTime) error {
	...
	//| %d	| Day of the month as a zero-padded decimal number.	| 30|
	//| %-d	| Day of the month as a decimal number. (Platform specific)	| 30|
	'd': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
	...
	//| %m	| Month as a zero-padded decimal number.	| 09|
	//| %-m	| Month as a decimal number. (Platform specific)	| 9|
	'm': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
	...
	//| %y	| Year without century as a zero-padded decimal number.	| 13|
	'y': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
	...
	//| %H	| Hour (24-hour clock) as a zero-padded decimal number.	| 07|
	//| %-H	| Hour (24-hour clock) as a decimal number. (Platform specific)	| 7|
	'H': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
	...
	//| %I	| Hour (12-hour clock) as a zero-padded decimal number.	| 07|
	//| %-I	| Hour (12-hour clock) as a decimal number. (Platform specific)	| 7|
	'I': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
	...
	//| %S	| Second as a zero-padded decimal number.	| 05|
	//| %-S	| Second as a decimal number. (Platform specific)	| 5|
	'S': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
	...
	//| %f	| Microsecond as a decimal number, zero-padded on the left.	| 000000|
	'f': func(val string, t *_DateTime) error {
		if nil == t {
			return errors.New("Invalid time parameter!")
		}
		return nil
